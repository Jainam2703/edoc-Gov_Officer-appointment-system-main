                ...
                <tr >
                    ...
                    <td >
                            <form action="schedule.php" method="post" class="header-search">
                                        ...
                                        <input type="search" name="search" class="input-text header-searchbar" placeholder="Search officer name or Email or Date (YYYY-MM-DD)" list="officer" >&nbsp;&nbsp;
                        ...
                        <tbody>
                            ...
                            if(($_GET)){
                                ...
                                if(isset($_GET["id"])){
                                    ...
                                    $sqlmain= "select * from schedule inner join officer on schedule.offid=officer.offid where schedule.scheduleid=$id  order by schedule.scheduledate desc";
                                            ...
                                            <div  class="dashboard-items search-items"  >
                                                ...
                                                <div style="width:100%">
                                                        ...
                                                        <div class="h3-search" style="font-size:18px;line-height:30px">
                                                            officer name:  &nbsp;&nbsp;<b>'.$offname.'</b><br>
                                                            officer Email:  &nbsp;&nbsp;<b>'.$offemail.'</b> 
                                                        </div>
